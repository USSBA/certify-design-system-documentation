$(document).ready(function() {
  ...
  var $editable_table = $('.sba-c-table--editable'),
      ...
      var getItemID = function(e){
        itemID = "#" + e.attr('id').replace('_edit','').replace('_delete','');
      }
      ...
      $add_button.on('click', function(){
        ...
        var next_id = Math.max.apply(Math,row_id_arr) + 1,
            ...
            data_row_id = table_name + '_tr' + next_id + '_data';
            fields_row_id = table_name + '_tr' + next_id + '_fields';
        ...
        $("#" + fields_row_id).append('<td colspan="' + table_cols + '"><ul class="sba-c-field-list"></li></td>');
